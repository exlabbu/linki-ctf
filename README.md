...
* ### ***ReconNG***
    ...
    [link github.com](https://github.com/lanmaster53/recon-ng)
...
* ### ***John the Ripper***
    ...
    [link github.com](https://github.com/openwall/john)
...
* ### ***Basic linux privilege escalation***
    ...
    Strona zawiera sporo metod na eskalacje uprawnień (trochę stare z 2011, ale może się to komuś przyda)

    [link g0tmi1k.com](https://blog.g0tmi1k.com/2011/08/basic-linux-privilege-escalation/)
...
* ### ***FOCA***
    ...
    [link github.com](https://github.com/ElevenPaths/FOCA)

## **Crypto**

* ### ***Ctf crypto for beginners***

    Strona zawierająca podstawowe informacje na temat kryptografii

    [link charcharbinks.com](https://charcharbinks.com/post/ctf_crypto_for_beginners/)
...
* ***Defenders think in lists. Attackers think in graphs. As long as this is true, attackers win.***
    ...
    [link github.com](https://github.com/JohnLaTwC/Shared/blob/master/Defenders%20think%20in%20lists.%20Attackers%20think%20in%20graphs.%20As%20long%20as%20this%20is%20true%2C%20attackers%20win.md)
...
* #### **CTF i podstawy**
    + ***Roppers***
        ...
        [link github.com](https://github.com/hoppersroppers)

        [link roppers.org](https://www.roppers.org/)

    + ***portswigger***

        [link portswigger.net](https://portswigger.net/web-security)
...
* #### **Threat inteligence**
    + ***ATT&CK kurs***
        ...
        [link mitre.org](https://attack.mitre.org/resources/training/cti/)

* #### **Threat hunting**
    + ***activecountermeasures***

        [link activecountermeasures.com](https://www.activecountermeasures.com/cyber-threat-hunting-training-course/)